...
class TestCorrectPermissions(FunctionalTestCase):
    ...
    def test_userb_delete_docb(self):
        ...
        browser.login(self.user_b).open(self.doc_b.absolute_url() + '/delete_confirmation')
    ...
    def test_usera_remove_folder(self):
        ...
        """
        browser = self.get_browser()
        browser.login(self.user_a).open(self.folder_a.absolute_url() + '/delete_confirmation')
    ...
    def test_userb_remove_folder(self):
        ...
        """
        browser = self.get_browser()
        browser.login(self.user_b).open(self.folder_a.absolute_url() + '/delete_confirmation')
    ...
    def test_usera_remove_doc_a(self):
        ...
        """
        browser = self.get_browser()
        browser.login(self.user_a).open(self.doc_a.absolute_url() + '/delete_confirmation')
    ...
    def test_usera_remove_doc_b(self):
        ...
        """
        browser = self.get_browser()
        browser.login(self.user_a).open(self.doc_b.absolute_url() + '/delete_confirmation')
        browser.delete(self.doc_b)
    ...
    def test_userb_remove_doc_a(self):
        ...
        """
        browser = self.get_browser()
        browser.login(self.user_b).open(self.doc_a.absolute_url() + '/delete_confirmation')
        with browser.expect_unauthorized():
            browser.delete(self.doc_a)
